...
export default function InfoBox({ info }){
    //const INIT_URL="https://media.istockphoto.com/id/95732127/photo/dusty-street-scene.jpg?s=612x612&w=is&k=20&c=QiyeMKf-Sk6VuqMGnf07DqSzT-NF6rOI4fpAiU_6zdU=";
const INIT_URL ="https://images.unsplash.com/photo-1580049904360-a9c3b79f86ff?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjR8fGR1c3R5JTIwd2VhdGhlcnxlbnwwfHwwfHx8MA%3D%3D";
    ...
    return(
      ...
      <CardContent>
        ...
        <p>The weather can be described as {" "}
            <b>{info.weather} </b> feels like={info.feelsLike}&deg;C</p>
        </Typography>
      </CardContent>
